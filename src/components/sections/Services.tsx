...
export function Services() {
  return (
    <section id="services" aria-labelledby="services-heading" className="border-t border-zinc-200 bg-white py-20 text-zinc-950 xl:py-28">
      <Container>
        <div className="mx-auto flex max-w-[1000px] flex-col items-center text-center">
          ...
          <h2 id="services-heading" className="mt-5 max-w-[980px] text-4xl font-medium leading-[1.08] tracking-[-0.05em] sm:text-5xl xl:text-[3.75rem]">
            Software built<br className="hidden sm:block" /> around your business.
          </h2>
          <p className="mt-6 max-w-[700px] text-base leading-7 text-zinc-600 sm:text-lg sm:leading-8">
