...
export function Insights() {
  ...
  return (
    <section id="insights" aria-labelledby="insights-heading" className="border-t border-zinc-200 bg-white py-20 text-zinc-950 xl:py-24">
      <Container>
        <div className="flex flex-wrap items-end justify-between gap-6">
          <h2 id="insights-heading" className="text-4xl font-semibold tracking-[-0.05em] sm:text-5xl">Insights from Northstack</h2>
        ...
        <div className="mt-10 flex gap-5 lg:gap-7">
          {visibleInsights.map((insight, index) => (
            <article key={insight.id} data-insight-card className={`min-w-0 flex-1 flex-col border border-zinc-200 ${index === 0 ? "flex" : index === 1 ? "hidden md:flex" : "hidden lg:flex"}`}>
              <div className="relative h-[220px] overflow-hidden bg-zinc-100 sm:h-[250px] lg:h-[270px]">
              ...
              <div className="flex flex-1 flex-col px-5 pb-6 pt-5 sm:px-6">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <span className="border border-zinc-300 px-2 py-1 font-[family-name:var(--font-space-mono)] text-[10px] font-bold tracking-[0.06em] text-zinc-700 uppercase">{insight.category}</span>
                ...
                <h3 className="mt-5 text-xl font-semibold leading-[1.2] tracking-[-0.035em] sm:text-2xl">
