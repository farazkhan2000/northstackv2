...
const fieldClass = "mt-2 w-full border-b border-white/30 bg-transparent px-0 py-3 text-base text-white outline-none transition-colors focus:border-[#91a7ff]";
const labelClass = "font-[family-name:var(--font-space-mono)] text-[11px] font-bold tracking-[0.08em] text-slate-300 uppercase";
...
export function ContactForm() {
  ...
  return (
    <section id="contact" aria-labelledby="contact-heading" className="bg-[#080b12] py-20 text-white xl:py-24">
      <Container className="flex flex-col gap-12 lg:flex-row lg:gap-16">
        <div className="lg:w-[38%]">
          ...
          <h2 id="contact-heading" className="mt-5 max-w-[470px] text-4xl font-semibold leading-[1.08] tracking-[-0.05em] sm:text-5xl xl:text-[3.5rem]">Let&apos;s build<br />something useful.</h2>
          <p className="mt-6 max-w-[420px] text-base leading-7 text-slate-300">Tell us what you&apos;re working on, what needs improving, or where you&apos;re stuck. We&apos;ll get back to you to discuss the next step.</p>
        ...
        <form onSubmit={handleSubmit} className="min-w-0 flex-1" aria-label="Project inquiry">
          ...
          <div className="mt-8 flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:gap-6">
            ...
            <p className="max-w-[310px] text-xs leading-5 text-slate-400">Online submissions are not active yet. Please email us directly.</p>
          </div>
